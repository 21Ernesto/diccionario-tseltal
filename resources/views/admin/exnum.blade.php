    ...
    <main class="p-4 md:ml-64 h-auto pt-20">
            ...
            <ol class="flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-xl font-semibold text-gray-400 md:ml-2">Exnums</span>
                    </div>
                </li>
            </ol>
            ...
            <table id="miTabla" class="w-full text-sm text-left">
                <thead class="text-xs text-gray-100 uppercase bg-gray-700 text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">Exnum</th>
                        <th scope="col" class="px-6 py-3">Xv</th>
                        <th scope="col" class="px-6 py-3">Xdial</th>
                        <th scope="col" class="px-6 py-3">Xe</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($exnums as $item)
                        <tr class="">
        ...
        <div class="mt-4">
            <ul class="flex items-center justify-end space-x-2">
                ...
                @for ($i = max($exnums->currentPage() - 2, 1); $i <= min($exnums->currentPage() + 1, $exnums->lastPage()); $i++)
                    <li>
                        <a href="{{ $exnums->url($i) }}"
                ...
                @if ($exnums->hasMorePages())
                    <li>
                        <a href="{{ $exnums->nextPageUrl() }}"
                            class="relative inline-flex items-center px-4 py-1.5 text-sm font-medium text-gray-100 bg-gray-700 cursor-pointer rounded">
                            Adelante
                        </a>
                    </li>
        ...
        <div id="abecedarioModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <div class="relative rounded-lg shadow bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <form method="POST" action="{{ route('exnums.import') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="p-6">
