            ...
            <ol class="flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-xl font-semibold text-gray-400 md:ml-2">Audios</span>
                    </div>
                </li>
            </ol>
        ...
        <div id="abecedarioModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <div class="relative rounded-lg shadow bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <form method="POST" action="{{ route('audio.import') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="p-6">
                            <label class="block text-sm mb-2 font-medium  text-white"
                                for="file_input">Seleccione los audios</label>
                            <input type="file" name="audios[]" multiple accept="audio/*" @required(true)
